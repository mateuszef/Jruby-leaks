...
public class MainThreadStartAndParseNotPooledRunsAndTerminates implements StressTest {
	...
	public MainThreadStartAndParseNotPooledRunsAndTerminates(Properties props) {
		this.props = props;
	}
