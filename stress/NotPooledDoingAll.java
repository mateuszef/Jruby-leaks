...
public class NotPooledDoingAll implements StressTest {
	private static AtomicInteger id = new AtomicInteger();
	private final Logger logger = LoggerFactory.getLogger(NotPooledDoingAll.class);
	...
	public NotPooledDoingAll(Properties props) {
		this.props = props;
	}
